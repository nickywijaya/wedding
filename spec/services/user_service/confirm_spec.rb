# spec/services/user_service/confirm_spec.rb
require 'rails_helper'

RSpec.describe UserService::Confirm do
  let(:user) { build_stubbed(:user) }

  subject { UserService.confirm(user) }
  ...
  describe '#perform' do
    context 'when success' do
      ...
      it 'should return no error and success confirm' do
        subject
